...
<div id="planet-detail">
    ...
    <div class="planet-globe">
        <img src="https://upload.wikimedia.org/wikipedia/commons/7/7f/Rotating_earth_animated_transparent.gif" alt="Earth">
    </div>
</div>
...
<div id="all-planets">
    <div class="planet-card">
        ...
        <img src="https://cdn.dribbble.com/userupload/22466647/file/original-faf91dd418f750c392bae4bf2728c3fa.gif" alt="Vénus">
    ...
    <div class="planet-card">
        ...
        <img src="https://media.tenor.com/hOkYXbvyIjYAAAAM/mars-model-3d-mars.gif" alt="Mars">
        <a class="btn-detail" href="mars.php">Voir plus</a>
        <h3>Mars</h3>
    </div>
    <div class="planet-card">
        <p>Jupiter is the largest planet in the solar system, a gas giant.</p>
        <img src="https://d2t1xqejof9utc.cloudfront.net/screenshots/pics/1513e482319672453c1eb17dd72df4a6/large.gif" alt="Jupiter">
        <a class="btn-detail" href="jupiter.php">Voir plus</a>
        <h3>Jupiter</h3>
    </div>
    <div class="planet-card">
        <p>Mercury is the closest planet to the Sun and the smallest.</p>
        <img src="https://i.pinimg.com/originals/d7/aa/19/d7aa1904f0b961caef4e85eb0d38120b.gif" alt="Mercury">
        <a class="btn-detail" href="mercury.php">Voir plus</a>
        <h3>Mercury</h3>
    </div>
    <div class="planet-card">
        <p>Uranus is an ice giant with a highly tilted rotation axis.</p>
        <img src="https://media.tenor.com/Cc8vOIn32VgAAAAM/uranus-planet.gif" alt="Uranus">
        <a class="btn-detail" href="uranus.php">Voir plus</a>
        <h3>Uranus</h3>
    </div>
    <div class="planet-card">
        <p>Saturn is famous for its beautiful rings.</p>
        <img src="https://media4.giphy.com/media/v1.Y2lkPTZjMDliOTUyNjRmMTFnZ3N2dmNlcnFpamViMG1tcmE3bmFvaDkxMTh3N2tmYzdzaiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7buctjKD8g5r4544/giphy.gif" alt="Saturn">
